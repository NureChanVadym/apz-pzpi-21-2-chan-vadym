...
namespace EcoMeChan.Repositories
{
    public class TariffRepository : ITariffRepository
    {
        ...
        public async Task<IEnumerable<Tariff>> GetByResourceTypeAsync(ResourceType resourceType)
        {
            return await _context.Tariffs
                .Include(t => t.Consumptions)
        ...
        public async Task<Tariff> GetByResourceTypeAndDateAsync(ResourceType resourceType, DateTime date)
        {
            return await _context.Tariffs
                .FirstOrDefaultAsync(t => t.ResourceType == resourceType && t.StartDate <= date && t.EndDate >= date);
        }
